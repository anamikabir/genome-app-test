...
List<String> geneList = subsetExpService.getTCGAlncRNARegulatoryNetworkGenes(subset1, subset2);
List<String> lncRNAList = subsetExpService.getTCGAlncRNARegulatoryNetworklncRNAs(subset1, subset2);
